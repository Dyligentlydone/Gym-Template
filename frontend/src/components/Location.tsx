    ...
    <section id="location" className="py-20">
      ...
      <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
          ...
          <p className="text-white/80">123 Fitness Ave, Suite 200<br/>Your City, ST 00000</p>
          ...
          <div className="mt-6">
            <a href="#contact" className="rounded-lg bg-[#39A0ED] hover:bg-[#2f8bd0] text-black font-semibold px-4 py-2 inline-block">Contact us</a>
          </div>
        </div>
