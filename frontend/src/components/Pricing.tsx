  ...
  return (
    <section id="pricing" className="py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto px-4">
        {plans.map((p) => (
          <div key={p.name} data-card-mask="true" className="rounded-2xl border border-gray-800 bg-black p-8 flex flex-col shadow-lg hover:shadow-xl transition-shadow duration-300">
